...
public class JewelObj : MonoBehaviour
{
    ...
    void JewelCrash()
    {
        ...
        EffectSpawner.effect.JewelCrashArray[x, y].transform.position =
    ...
    public void getNewPosition()
    {
        ...
        {
            if (GribManager.cell.Map[x, y] != 0 && GribManager.cell.GribCellObj[x, y].cell.CellEffect != 4 &&
    ...
    List<JewelObj> GetLeft(Vector2 Pos, int type)
    {
        ...
        {
            if (x != jewel.JewelPosition.x && JewelSpawner.spawn.JewelGribScript[x, (int) Pos.y] != null &&
                JewelSpawner.spawn.JewelGribScript[x, (int) Pos.y].jewel.JewelType == type &&
                GribManager.cell.GribCellObj[x, (int) Pos.y].cell.CellEffect == 0)
    ...
    List<JewelObj> GetTop(Vector2 Pos, int type)
    {
        ...
        {
            if (y != jewel.JewelPosition.y && JewelSpawner.spawn.JewelGribScript[(int) Pos.x, y] != null &&
